...
function Game() {
    ...
    const {isDividingPot, isErrorDividingPot, triggerDividePot, winners} = useDividePot(round?.id, String(gameId));
    ...
    if (isErrorDividingPot || !winners) return <Alert severity="error" variant="filled">Error splitting winnings</Alert>
